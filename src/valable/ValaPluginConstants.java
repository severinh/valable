...
public interface ValaPluginConstants {
	...
	public static final Set<String> IMG_KEYS = Collections
			.unmodifiableSet(new LinkedHashSet<String>(Arrays.asList(
					...
					IMG_OBJECT_ENUM_DEFAULT, IMG_OBJECT_ENUM_PRIVATE,
					IMG_OBJECT_ENUM_PUBLIC, IMG_OBJECT_ENUM_PROTECTED,
					IMG_OBJECT_LOCAL_VARIABLE, IMG_OBJECT_FIELD_DEFAULT,
					IMG_OBJECT_FIELD_PRIVATE, IMG_OBJECT_FIELD_PUBLIC,
					IMG_OBJECT_FIELD_PROTECTED, IMG_OBJECT_METHOD_DEFAULT,
					IMG_OBJECT_METHOD_PRIVATE, IMG_OBJECT_METHOD_PUBLIC,
					IMG_OBJECT_METHOD_PROTECTED, IMG_OVERLAY_ABSTRACT,
